              ...
              >
                ...
                <div className={`ml-12 md:ml-0 md:w-5/12 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'}`}>
                  <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="mb-4">
                      ...
                      <div className="flex flex-wrap items-center gap-4 text-sm text-gray-600 mb-2">
                        ...
                        <div className="flex items-center">
                          ...
                          {experience.location}
                          {experience.isRemote && (
                            <span className="ml-1 text-blue-600">({t.experience.remoteLabel})</span>
                          )}
                        </div>
                      </div>
                    ...
                    {/* Achievements */}
                    <div className="mb-6">
                      <h4 className="font-semibold text-gray-900 mb-3">{t.experience.achievementsTitle}</h4>
                    ...
                    {/* Technologies */}
                    <div>
                      <h4 className="font-semibold text-gray-900 mb-3">{t.experience.technologiesTitle}</h4>
